...
export class Backend implements backendInterface {
    ...
    async deleteEnquiry(arg0: EnquiryId): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getAndMarkEnquiryAsContacted(arg0: EnquiryId): Promise<Enquiry> {
        if (this.processError) {
            try {
                const result = await this.actor.getAndMarkEnquiryAsContacted(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getEnquiriesByStatus(arg0: string): Promise<Array<Enquiry>> {
        if (this.processError) {
            try {
                const result = await this.actor.getEnquiriesByStatus(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getEnquiry(arg0: EnquiryId): Promise<Enquiry> {
        if (this.processError) {
            try {
    ...
    async hasEnquiries(): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.hasEnquiries();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateEnquiryStatus(arg0: EnquiryId, arg1: string): Promise<void> {
        if (this.processError) {
            try {
